...
// Bạn có thể thay thế bằng hình ảnh thật sau
const instructors = [
  {
    name: "Cô Minh Anh",
    ...
    avatar: "https://placehold.co/150x150/EBF4FF/6366F1?text=GV",
  },
  {
    name: "Thầy Đức Trung",
...
const Instructors = () => {
  return (
    // Chúng ta dùng bg-white để làm nổi bật section này
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Đội ngũ chuyên gia 8.0+ IELTS với nhiều năm kinh nghiệm, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {instructors.map((instructor, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-2xl shadow-lg card-hover text-center transition-all duration-300"
            >
              <img
